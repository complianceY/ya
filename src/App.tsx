      ...
      <section ref={heroRef} className="relative pt-24 pb-20 min-h-screen flex items-center bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 
  className="hero-heading text-5xl md:text-6xl font-bold mb-6 cursor-pointer select-none space-y-2"
  onMouseEnter={() => setIsHovering(true)}
  onMouseLeave={() => setIsHovering(false)}
>
              <div className="block">
                <span 
                  className="inline-block animate-fade-in-up mt-100 text-transparent bg-clip-text bg-gradient-to-r from-gray-800 via-gray-900 to-black hover:from-blue-600 hover:via-purple-600 hover:to-cyan-600 transition-all duration-700 transform hover:scale-105"
