...
>
              ...
              <div className="block">
                <span className="relative inline-block group">
                  ...
                  <div 
                    className="absolute inset-0 bg-gradient-to-r from-blue-400/20 via-cyan-400/20 to-teal-400/1 blur-3xl opacity-0 group-hover:opacity-100 transition-all duration-700 rounded-lg"
                    style={{
